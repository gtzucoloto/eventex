...
class SubscribePostTest(TestCase):
    ...
    def test_subscription_email_to(self):
        email = mail.outbox[0]
        expect = ['contato@eventex.com.br', 'gtzucoloto@gmail.com']
        self.assertEqual(expect, email.to)

    def test_subscription_email_body(self):
        email = mail.outbox[0]
        self.assertIn("Gabriel Zucoloto", email.body)
        self.assertIn("12345678901", email.body)
        self.assertIn("gtzucoloto@gmail.com", email.body)
        self.assertIn("27-995101402", email.body)
